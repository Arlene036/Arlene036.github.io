...
- Improve link diary in archive listings. [#276](https://github.com/mmistakes/minimal-mistakes/issues/276)
...
- Add translation key for "Recent diary" used in home page `index.html`. [#316](https://github.com/mmistakes/minimal-mistakes/pull/316)
...
- Fix alignment issues with related diary [#273](https://github.com/mmistakes/minimal-mistakes/issues/273) and "Follow" button in author profile [#274](https://github.com/mmistakes/minimal-mistakes/issues/274).
...
- Increased the amount of sample diary, sample pages, and sample collections to throughly test the theme and edge-cases.
...
- Added taxonomy links to diary (tags and categories).
...
- Only show related diary if there are one or more available
...
- Fix typos in diary and documentation and remove references to Less
...
- Include new sample feature images for diary and pages
- Table of contents improvements: fix collapse toggle, indent nested elements, show on small screens, and create an `_include` for reusing in diary and pages.
